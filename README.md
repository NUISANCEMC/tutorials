<img src="https://nuisance.hepforge.org/images/nuisancelogo.png" alt="nuwro-logo" width="100"/>

# NUISANCE TUTORIAL: NUINT 2024 

## Binder Taster
The NUISANCE tutorial can also be run remotely online using binder. Note that CPU and memory is limited for binder examples so this should be used as a last result to get used to different NUISANCE processing steps if interactive docker/singularity options are not available during the tutorial. Binder requires some familiarity with Jupyter lab. To start an interactive binder instance click the link below.

[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/NUISANCEMC/tutorials/HEAD)
