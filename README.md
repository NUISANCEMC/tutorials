...
## Binder Taster
The NUISANCE tutorial can also be run remotely online using binder. Note that CPU and memory is limited for binder examples so this should be used as a last result to get used to different NUISANCE 
processing steps.
